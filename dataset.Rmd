...
# Yes this hurts me.
visited <- tibble(
  Volcanoes = c("Maungauika / North Head", "Takarunga / Mount Victoria", "Albert Park Volcano", "Maungakiekie / One Tree Hill", "Te Kōpuke / Tītīkōpuke / Mount St John", "Ōhinerau / Mount Hobson", "Ohuiarangi / Pigeon Mountain"),
  Visited = T, # Redundant column for future filters or whatever idk
  `Date visited` = c("2023-07-11", "2023-07-11", "2023-07-17", "2023-07-22", "2023-07-22", "2023-07-22", "2023-07-30")
)
...
##### [Back to En cours homepage](https://encours.neocities.org/)