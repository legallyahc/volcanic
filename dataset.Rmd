...
# Yes this hurts me.
visited <- tibble(
  Volcanoes = c("Maungauika / North Head", "Takarunga / Mount Victoria", "Albert Park Volcano"),
  Visited = T, # Redundant column for future filters or whatever idk
  `Date visited` = c("2023-07-11", "2023-07-11", "2023-07-17")
)
...
Originally published on 2023-07-16. Version 1.1.